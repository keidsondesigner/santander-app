...
import 'package:santander_app/models/user_list_model/news.dart';
...
class SlideCardsWidget extends StatefulWidget {
  ...
  const SlideCardsWidget({super.key, required this.news});

  @override
  State<SlideCardsWidget> createState() => _SlideCardsWidgetState();
}

class _SlideCardsWidgetState extends State<SlideCardsWidget> {
